...
CanSILFunctionType SILFunctionType::getAutoDiffDerivativeFunctionType(
  ...
  for (const auto &[index, param] :
    ...
    auto &tl = TC.getTypeLowering(pattern, paramTanType,
    ...
    singleParam.emplace_back(paramTanType, singleParamConv);
    ...
    CanSILFunctionType pullbackType = SILFunctionType::get(
        ...
        silFunctionType->getCalleeConvention(), singleParam, yields,
        singleResult, std::nullopt, substitutions, SubstitutionMap(), ctx);
