...
//                                  std::pair<BridgedInstruction, SwiftInt>,
//                                  8>>,
//     BridgedTypeHasher>
//     closuresBuffers;
...
//         }
//       }
//       newTupleElTypes.emplace_back(type,
//       oldTupleTy->getElement(i).getName()); continue;
//     }
...
//       swift::TupleType::get(newTupleElTypes,
//       bb->getModule().getASTContext()));
...
//   topVjp.getFunction()->getGenericEnvironment())
//     genericSig =
//         derivativeFnGenEnv->getGenericSignature().getCanonicalSignature();
//   GenericParamList *genericParams = nullptr;
//   if (genericSig)
//     genericParams =
//         cloneGenericParameters(astContext, oldED->getDeclContext(),
//         genericSig);
...
//     auto *newParamDecl = ParamDecl::cloneWithoutType(astContext,
//     &oldParamDecl); newParamDecl->setInterfaceType(newTupleType);
...
//   SILType newEnumType =
//   topVjp.getFunction()->getModule().Types.getLoweredType(
//       pattern, traceDeclType, TypeExpansionContext::minimal());
