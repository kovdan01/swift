    ...
    if isSingleBB {
      ...
      var (specializedFunction, alreadyExists) =
        getOrCreateSpecializedFunctionCFG(
          basedOn: callSite, enumDict: &enumDict, bbMap: bbMap, context)
...
private func getOrCreateSpecializedFunctionCFG(
  basedOn callSite: CallSite, enumDict: inout EnumDict, bbMap: [BasicBlock: BasicBlock],
        ...
        ti == returnInst.returnedValue
      {
        ...
        for tiUse in ti.uses {
          ...
          closureInfoArr.append(
            ClosureInfoCFG(
              closure: rootClosure, idxesInEnumPayload: [idxInEnumPayload],
