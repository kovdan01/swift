...
public struct Builder {
  ...
  public func rewriteBranchTracingEnum(enumType: Type, enumCaseIdx: Int, closureIdxInTuple: Int, topVjpFunction: Function) -> Type {
    return bridged.rewriteBranchTracingEnum(enumType.bridged, enumCaseIdx, closureIdxInTuple, topVjpFunction.bridged).type
  }
