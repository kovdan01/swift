...
SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedParamDecl BridgedParamDecl_cloneWithoutType(BridgedParamDecl pd);
...
struct BridgedDeclObj {
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedASTType EnumElementDecl_getPayloadInterfaceType() const;
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedParameterList EnumElementDecl_getParameterList() const;
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedStringRef EnumElementDecl_getNameStr() const;
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedNominalTypeDecl asNominalTypeDecl() const;
...
SWIFT_NAME("getter:Bridged" #Id "Decl.asNominalTypeDecl(self:)")                 \
    BridgedNominalTypeDecl Bridged##Id##Decl_asNominalTypeDecl(Bridged##Id##Decl decl);
#include "swift/AST/DeclNodes.def"
...
SWIFT_NAME("getter:Bridged" #Id "Decl.asGenericContext(self:)")                 \
    BridgedGenericContext Bridged##Id##Decl_asGenericContext(Bridged##Id##Decl decl);
...
BRIDGED_INLINE void BridgedSourceFile_addTopLevelDecl(BridgedSourceFile sf, BridgedDecl decl);
...
// SWIFT_NAME("BridgedNominalTypeDecl.setImplicit(self:)")
// BRIDGED_INLINE void BridgedNominalTypeDecl_setImplicit(BridgedNominalTypeDecl cDecl);

SWIFT_NAME("BridgedGenericContext.setGenericSignature(self:_:)")
BRIDGED_INLINE void BridgedGenericContext_setGenericSignature(BridgedGenericContext cDecl, BridgedGenericSignature cGenSig);

SWIFT_NAME("BridgedNominalTypeDecl.addMember(self:_:)")
BRIDGED_INLINE void BridgedNominalTypeDecl_addMember(BridgedNominalTypeDecl cDecl, BridgedDecl member);
...
SWIFT_NAME(
    "BridgedEnumDecl.create(_:declContext:name:genericParamList:)")
BridgedEnumDecl BridgedEnumDecl_create(
    BridgedASTContext cContext, BridgedDeclContext cDeclContext,
    BridgedStringRef name, BridgedNullableGenericParamList genericParamList);
...
BridgedEnumElementDecl BridgedEnumElementDecl_create(
    BridgedASTContext cContext, BridgedDeclContext cDeclContext,
    BridgedStringRef name,
    BridgedParameterList parameterList);

// SWIFT_NAME("BridgedEnumElementDecl.setImplicit(self:)")
...
BridgedParameterList BridgedParameterList_create(
    BridgedASTContext cContext, BridgedArrayRef cParameters);
...
struct BridgedASTType {
  ...
  //SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedCanType getReducedTypeInFunction(BridgedCanType functionTy) const;
