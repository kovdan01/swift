...
BridgedASTType
BridgedDeclObj::NominalType_getDeclaredInterfaceType() const {
  return {getAs<swift::NominalTypeDecl>()->getDeclaredInterfaceType().getPointer()};
}
...
unsigned BridgedASTType::GenericTypeParam_getDepth() const {
  return llvm::cast<swift::GenericTypeParamType>(type)->getDepth();
}

unsigned BridgedASTType::GenericTypeParam_getIndex() const {
  return llvm::cast<swift::GenericTypeParamType>(type)->getIndex();
}

swift::GenericTypeParamKind BridgedASTType::GenericTypeParam_getParamKind() const {
...
BridgedCanGenericSignature BridgedCanType::SILFunctionType_getSubstGenericSignature() const {
  return {swift::CanSILFunctionType(llvm::cast<swift::SILFunctionType>(type))->getSubstGenericSignature().getPointer()};
}
