...
BridgedInstruction BridgedClosureArray::at(SwiftInt index) const {
  return {const_cast<swift::SingleValueInstruction *>(
      llvm::cast<swift::SingleValueInstruction>(
          &closureArray.unbridged<swift::SILInstruction>()[index]))};
}
