...
struct BridgedType {
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedDeclObj getEnumElementDecl(EnumElementIterator i) const;
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedCanType getRemappedType(BridgedFunction function) const;
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedType mapTypeOutOfContext() const;
};

SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedType SILType_getPrimitiveType(BridgedCanType t, SwiftInt silValueCategory);
...
struct BridgedFunction {
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedType mapSILTypeIntoContext(BridgedType ty) const;
  ...
  BRIDGED_INLINE bool hasGenericEnvironment() const;
...
struct BridgedBasicBlock {
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedArgument insertPhiArgument(SwiftInt index, BridgedType type, BridgedValue::Ownership ownership) const;
...
struct BridgedContext {
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedASTType getTupleTypeWithLabels(BridgedArrayRef elementTypes, BridgedArrayRef labels) const;
