...
enum class BridgedValueCategory {
  Address,
  Object
};
...
struct BridgedType {
  ...
  getRemappedType(BridgedFunction function) const;
...
struct BridgedFunction {
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedType
  mapSILTypeIntoContext(BridgedType ty) const;
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedType getLoweredType(BridgedCanType type) const;
