...
#include "swift/AST/Builtins.def"
  ...
  BRIDGED_INLINE bool DifferentiableFunctionInst_hasExtractee(SwiftInt extractee) const;
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedValue DifferentiableFunctionInst_getExtractee(SwiftInt extractee) const;
  BRIDGED_INLINE SwiftInt DifferentiableFunctionExtractInst_extractee() const;
