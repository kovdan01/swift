...
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#A5:]] = begin_access [modify] [static] %[[#A0]] : $*Float
...
///   %64 = apply %62<Float>(%57, %[[#B12]], %[[#B13]], %63)
...
// DEBUG-NEXT:  [AD] The following active value is loop-local, zeroing its adjoint buffer in loop header:   %[[#B01:]] = alloc_stack [var_decl] $Float, var, name "temp", type $Float
...
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#B08:]] = begin_access [read] [static] %[[#B00]] : $*Float
...
// DEBUG-NEXT:  [AD] No debug variable found.
// DEBUG-NEXT:  [AD] The new adjoint value, replacing the existing one, is: Zero[$Float]
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#B10:]] = begin_access [read] [static] %[[#B01]] : $*Float
...
// DEBUG-NEXT:  [AD] No debug variable found.
// DEBUG-NEXT:  [AD] The new adjoint value, replacing the existing one, is: Zero[$Float]
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#B15:]] = begin_access [modify] [static] %[[#B00]] : $*Float
...
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#B02]] = begin_access [read] [static] %[[#B01]] : $*Float
...
// DEBUG-NEXT:  [AD] No debug variable found.
// DEBUG-NEXT:  [AD] The new adjoint value, replacing the existing one, is: Zero[$Float]
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#B07]] = begin_access [modify] [static] %[[#B01]] : $*Float
...
// DEBUG-NEXT:  [AD] The following active value is NOT loop-local, skipping: %[[#CARG0]] = argument of bb0 : $Float
// DEBUG-NEXT:  [AD] The following active value is NOT loop-local, skipping:   %[[#C00]] = alloc_stack [var_decl] $Float, var, name "result", type $Float
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#C01:]] = begin_access [read] [static] %[[#C00]] : $*Float
...
// DEBUG-NEXT:  [AD] No debug variable found.
// DEBUG-NEXT:  [AD] The new adjoint value, replacing the existing one, is: Zero[$Float]
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#C03:]] = begin_access [read] [static] %[[#C00]] : $*Float
...
// DEBUG-NEXT:  [AD] No debug variable found.
// DEBUG-NEXT:  [AD] The new adjoint value, replacing the existing one, is: Zero[$Float]
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#]] = begin_access [modify] [static] %[[#C00]] : $*Float

// DEBUG-NEXT:  [AD] Original bb4 belongs to a loop, original header bb1, pullback header bb10
// DEBUG-NEXT:  [AD] The following active value is NOT loop-local, skipping: %[[#CARG0]] = argument of bb0 : $Float
// DEBUG-NEXT:  [AD] The following active value is NOT loop-local, skipping:   %[[#C00]] = alloc_stack [var_decl] $Float, var, name "result", type $Float
// DEBUG-NEXT:  [AD] The following active value is loop-local, but it is an address projection, skipping:   %[[#C08:]] = begin_access [read] [static] %[[#C00]] : $*Float
