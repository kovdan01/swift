...
// RUN: not grep "^// pullback of myfoo19" %t/out.sil
// RUN: not grep "^// pullback of myfoo20" %t/out.sil

// TODO: both pullback and specialized pullback are present, is this OK?
// TODO: RUN not grep "^// pullback of myfoo17" %t/out.sil

// TODO: only non-specialized pullback present, is this OK?
// TODO: RUN not grep "^// pullback of myfoo21" %t/out.sil
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test01") {
  ...
  // TODO: can we use definitions for differentiability witnesses of mybar1 and mybar2 to inline their VJPs and do ADCS?
  ...
  // CHECK01:         %42 = function_ref @$s3outyycfU_7myfoo01L_yS2fFTJpSpSr019$_AD__$s3outyycfU_7B30L_yS2fF_bb3__Pred__src_0_wrt_0Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU_7myfoo01L_yS2fF_bb3__Pred__src_0_wrt_0_spec_bb2_3_bb1_3) -> Float // user: %43
  // CHECK01:         %43 = partial_apply [callee_guaranteed] %42(%41) : $@convention(thin) (Float, @owned _AD__$s3outyycfU_7myfoo01L_yS2fF_bb3__Pred__src_0_wrt_0_spec_bb2_3_bb1_3) -> Float // user: %44
  // CHECK01:         %44 = tuple (%40, %43)                          // user: %45
  // CHECK01:         return %44                                      // id: %45
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test02") {
  ...
  // CHECK02:         %72 = function_ref @$s3outyycfU0_7myfoo02L_yS2fFTJpSpSr073$sSf16_DifferentiationE12_vjpMultiply3lhs3rhsSf5value_Sf_SftSfc8pullbacktj1_k5FZSf_K6SfcfU_S2fACS2f0cd1_e3E7_g11Add3lhs3rhsi1_j1_klj1_km1_kN2U_Tf1nnccc_n020$_AD__$s3outyycfU0_7B30L_yS2fF_bb3__Pred__src_0_wrt_0Tf1bnnnnn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU0_7myfoo02L_yS2fF_bb3__Pred__src_0_wrt_0_spec_bb2_3_bb1_3_5, Float, Float, Float, Float) -> Float // user: %73
  // CHECK02:         %73 = partial_apply [callee_guaranteed] %72(%65, %0, %66, %16, %16) : $@convention(thin) (Float, @owned _AD__$s3outyycfU0_7myfoo02L_yS2fF_bb3__Pred__src_0_wrt_0_spec_bb2_3_bb1_3_5, Float, Float, Float, Float) -> Float // user: %74
  // CHECK02:         %74 = tuple (%71, %73)                          // user: %75
  // CHECK02:         return %74                                      // id: %75
  // CHECK02:       } // end sil function '$s3outyycfU0_7myfoo02L_yS2fFTJrSpSr'

  // CHECK02-LABEL: {{^}}// specialized pullback of myfoo02
  // CHECK02-NEXT:  // Isolation: nonisolated
  // CHECK02-NEXT:  sil private @$s3outyycfU0_7myfoo02L_yS2fFTJpSpSr073$sSf16_DifferentiationE12_vjpMultiply3lhs3rhsSf5value_Sf_SftSfc8pullbacktj1_k5FZSf_K6SfcfU_S2fACS2f0cd1_e3E7_g11Add3lhs3rhsi1_j1_klj1_km1_kN2U_Tf1nnccc_n020$_AD__$s3outyycfU0_7B30L_yS2fF_bb3__Pred__src_0_wrt_0Tf1bnnnnn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU0_7myfoo02L_yS2fF_bb3__Pred__src_0_wrt_0_spec_bb2_3_bb1_3_5, Float, Float, Float, Float) -> Float {
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test03") {
  ...
  // CHECK03:         %44 = function_ref @$s3outyycfU1_7myfoo03L_yS2fFTJpSpSr020$_AD__$s3outyycfU1_7B30L_yS2fF_bb5__Pred__src_0_wrt_0Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU1_7myfoo03L_yS2fF_bb5__Pred__src_0_wrt_0_spec_bb4_2_bb3_2_bb1_3) -> Float // user: %45
  // CHECK03:         %45 = partial_apply [callee_guaranteed] %44(%43) : $@convention(thin) (Float, @owned _AD__$s3outyycfU1_7myfoo03L_yS2fF_bb5__Pred__src_0_wrt_0_spec_bb4_2_bb3_2_bb1_3) -> Float // user: %46
  // CHECK03:         %46 = tuple (%42, %45)                          // user: %47
  // CHECK03:         return %46                                      // id: %47
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test04") {
  ...
  // CHECK04:         %46 = function_ref @$s3outyycfU2_7myfoo04L_yS2fFTJpSpSr020$_AD__$s3outyycfU2_7B30L_yS2fF_bb6__Pred__src_0_wrt_0Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU2_7myfoo04L_yS2fF_bb6__Pred__src_0_wrt_0_spec_bb5_3_bb1_3) -> Float // user: %47
  // CHECK04:         %47 = partial_apply [callee_guaranteed] %46(%45) : $@convention(thin) (Float, @owned _AD__$s3outyycfU2_7myfoo04L_yS2fF_bb6__Pred__src_0_wrt_0_spec_bb5_3_bb1_3) -> Float // user: %48
  // CHECK04:         %48 = tuple (%44, %47)                          // user: %49
  // CHECK04:         return %48                                      // id: %49
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test05") {
  ...
  // CHECK05:         %36 = function_ref @$s3outyycfU3_7myfoo05L_yS2fFTJpSpSr020$_AD__$s3outyycfU3_7B30L_yS2fF_bb3__Pred__src_0_wrt_0Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU3_7myfoo05L_yS2fF_bb3__Pred__src_0_wrt_0_spec_bb2_1_2_3_bb1_1_2_3) -> Float // user: %37
  // CHECK05:         %37 = partial_apply [callee_guaranteed] %36(%35) : $@convention(thin) (Float, @owned _AD__$s3outyycfU3_7myfoo05L_yS2fF_bb3__Pred__src_0_wrt_0_spec_bb2_1_2_3_bb1_1_2_3) -> Float // user: %38
  // CHECK05:         %38 = tuple (%34, %37)                          // user: %39
  // CHECK05:         return %38                                      // id: %39
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test06") {
  ...
  // CHECK06:         %81 = function_ref @$s3outyycfU4_7myfoo06L_yS2fFTJpSpSr020$_AD__$s3outyycfU4_7B31L_yS2fF_bb10__Pred__src_0_wrt_0Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU4_7myfoo06L_yS2fF_bb10__Pred__src_0_wrt_0_spec_bb9_1_bb8_2_bb5_2_3_bb4_2_3) -> Float // user: %82
  // CHECK06:         %82 = partial_apply [callee_guaranteed] %81(%80) : $@convention(thin) (Float, @owned _AD__$s3outyycfU4_7myfoo06L_yS2fF_bb10__Pred__src_0_wrt_0_spec_bb9_1_bb8_2_bb5_2_3_bb4_2_3) -> Float // user: %83
  // CHECK06:         %83 = tuple (%79, %82)                          // user: %84
  // CHECK06:         return %83                                      // id: %84
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test07") {
  ...
  // CHECK07:         %34 = function_ref @$s3outyycfU5_7myfoo07L_yS2f_SbtFTJpSUpSr020$_AD__$s3outyycfU5_7B34L_yS2f_SbtF_bb3__Pred__src_0_wrt_0Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU5_7myfoo07L_yS2f_SbtF_bb3__Pred__src_0_wrt_0_spec_bb2_1_bb1_1_2) -> Float // user: %35
  // CHECK07:         %35 = partial_apply [callee_guaranteed] %34(%32) : $@convention(thin) (Float, @owned _AD__$s3outyycfU5_7myfoo07L_yS2f_SbtF_bb3__Pred__src_0_wrt_0_spec_bb2_1_bb1_1_2) -> Float // user: %36
  // CHECK07:         %36 = tuple (%33, %35)                          // user: %37
  // CHECK07:         return %36                                      // id: %37
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test08") {
  ...
  // CHECK08:         %52 = function_ref @$s3outyycfU6_7myfoo08L_yS2f_SftFTJpSSpSr073$sSf16_DifferentiationE12_vjpMultiply3lhs3rhsSf5value_Sf_SftSfc8pullbacktj1_k5FZSf_K6SfcfU_S2fTf1nnc_n020$_AD__$s3outyycfU6_7b7L_yS2f_K26F_bb6__Pred__src_0_wrt_0_1Tf1bnnn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU6_7myfoo08L_yS2f_SftF_bb6__Pred__src_0_wrt_0_1_spec, Float, Float) -> (Float, Float) // user: %53
  // CHECK08:         %53 = partial_apply [callee_guaranteed] %52(%46, %30, %45) : $@convention(thin) (Float, @owned _AD__$s3outyycfU6_7myfoo08L_yS2f_SftF_bb6__Pred__src_0_wrt_0_1_spec, Float, Float) -> (Float, Float) // user: %54
  // CHECK08:         %54 = tuple (%50, %53)                          // user: %55
  // CHECK08:         return %54                                      // id: %55
  // CHECK08:       } // end sil function '$s3outyycfU6_7myfoo08L_yS2f_SftFTJrSSpSr'

  // CHECK08-LABEL: {{^}}// specialized pullback of myfoo08
  // CHECK08-NEXT:  // Isolation: nonisolated
  // CHECK08-NEXT:  sil private @$s3outyycfU6_7myfoo08L_yS2f_SftFTJpSSpSr073$sSf16_DifferentiationE12_vjpMultiply3lhs3rhsSf5value_Sf_SftSfc8pullbacktj1_k5FZSf_K6SfcfU_S2fTf1nnc_n020$_AD__$s3outyycfU6_7b7L_yS2f_K26F_bb6__Pred__src_0_wrt_0_1Tf1bnnn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU6_7myfoo08L_yS2f_SftF_bb6__Pred__src_0_wrt_0_1_spec, Float, Float) -> (Float, Float) {
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test09,Test10") {
  ...
  // CHECK09:         %30 = function_ref @$s3outyycfU7_7myfoo09L_ySfAAyycfU7_4EnumL_O_SftFTJpUSpSr020$_AD__$s3outyycfU7_7b11L_ySfAAyycff2_4C31L_O_SftF_bb3__Pred__src_0_wrt_1Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU7_7myfoo09L_ySfAAyycfU7_4EnumL_O_SftF_bb3__Pred__src_0_wrt_1_spec_bb2_1_bb1_1) -> Float // user: %31
  // CHECK09:         %31 = partial_apply [callee_guaranteed] %30(%29) : $@convention(thin) (Float, @owned _AD__$s3outyycfU7_7myfoo09L_ySfAAyycfU7_4EnumL_O_SftF_bb3__Pred__src_0_wrt_1_spec_bb2_1_bb1_1) -> Float // user: %32
  // CHECK09:         %32 = tuple (%28, %31)                          // user: %33
  // CHECK09:         return %32                                      // id: %33
  ...
  // CHECK10:         %73 = function_ref @$s3outyycfU7_7myfoo10L_ySfAAyycfU7_8IndirectL_O_SftFTJpUSpSr020$_AD__$s3outyycfU7_7b11L_ySfAAyycff2_8C31L_O_SftF_bb5__Pred__src_0_wrt_1Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU7_7myfoo10L_ySfAAyycfU7_8IndirectL_O_SftF_bb5__Pred__src_0_wrt_1_spec_bb3_2_bb2_2) -> Float // user: %74
  // CHECK10:         %74 = partial_apply [callee_guaranteed] %73(%72) : $@convention(thin) (Float, @owned _AD__$s3outyycfU7_7myfoo10L_ySfAAyycfU7_8IndirectL_O_SftF_bb5__Pred__src_0_wrt_1_spec_bb3_2_bb2_2) -> Float // user: %75
  // CHECK10:         %75 = tuple (%71, %74)                          // user: %76
  // CHECK10:         return %75                                      // id: %76
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test11") {
  ...
  // CHECK11:         %44 = function_ref @$s3outyycfU8_7myfoo11L_yS2f_SftFTJpSSpSr020$_AD__$s3outyycfU8_7B37L_yS2f_SftF_bb10__Pred__src_0_wrt_0_1Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU8_7myfoo11L_yS2f_SftF_bb10__Pred__src_0_wrt_0_1_spec_bb9_1_bb6_1_bb5_1_bb3_1) -> (Float, Float) // user: %45
  // CHECK11:         %45 = partial_apply [callee_guaranteed] %44(%43) : $@convention(thin) (Float, @owned _AD__$s3outyycfU8_7myfoo11L_yS2f_SftF_bb10__Pred__src_0_wrt_0_1_spec_bb9_1_bb6_1_bb5_1_bb3_1) -> (Float, Float) // user: %46
  // CHECK11:         %46 = tuple (%42, %45)                          // user: %47
  // CHECK11:         return %46                                      // id: %47
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test12") {
  ...
  // CHECK12:         %82 = function_ref @$s3outyycfU9_7myfoo12L_2x02x12x22x3S2d_S2dSgAGtFTJpSSSSpSr020$_AD__$s3outyycfU9_7b18L_2x02x12x22x3S2d_K36SgAGtF_bb12__Pred__src_0_wrt_0_1_2_3Tf1bn_n : $@convention(thin) (Double, @owned _AD__$s3outyycfU9_7myfoo12L_2x02x12x22x3S2d_S2dSgAGtF_bb12__Pred__src_0_wrt_0_1_2_3_spec) -> (Double, Double, Optional<Double>.TangentVector, Optional<Double>.TangentVector) // user: %83
  // CHECK12:         %83 = partial_apply [callee_guaranteed] %82(%80) : $@convention(thin) (Double, @owned _AD__$s3outyycfU9_7myfoo12L_2x02x12x22x3S2d_S2dSgAGtF_bb12__Pred__src_0_wrt_0_1_2_3_spec) -> (Double, Double, Optional<Double>.TangentVector, Optional<Double>.TangentVector) // user: %84
  // CHECK12:         %84 = tuple (%81, %83)                          // user: %85
  // CHECK12:         return %84                                      // id: %85
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test13") {
  ...
  // CHECK13:         %21 = function_ref @$s3outyycfU10_7myfoo13L_1x1ySfAAyycfU10_1XL_V_SitFTJpSUpSr021$_AD__$s3outyycfU10_7b14L_1x1ySfAAyycfE34_1XL_V_SitF_bb3__Pred__src_0_wrt_0Tf1bn_n : $@convention(thin) (Float, @owned _AD__$s3outyycfU10_7myfoo13L_1x1ySfAAyycfU10_1XL_V_SitF_bb3__Pred__src_0_wrt_0_spec_bb1_1) -> X.TangentVector // user: %22
  // CHECK13:         %22 = partial_apply [callee_guaranteed] %21(%20) : $@convention(thin) (Float, @owned _AD__$s3outyycfU10_7myfoo13L_1x1ySfAAyycfU10_1XL_V_SitF_bb3__Pred__src_0_wrt_0_spec_bb1_1) -> X.TangentVector // user: %23
  // CHECK13:         %23 = tuple (%19, %22)                          // user: %24
  // CHECK13:         return %23                                      // id: %24
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test14,Test15") {
  ...
  // CHECK14:         %53 = function_ref @$s3outyycfU11_7myfoo14L_ySf_SftSf_SftFTJpSSpSSr021$_AD__$s3outyycfU11_7b9L_ySf_Sftf1_G28F_bb5__Pred__src_0_1_wrt_0_1Tf1bnn_n : $@convention(thin) (Float, Float, @owned _AD__$s3outyycfU11_7myfoo14L_ySf_SftSf_SftF_bb5__Pred__src_0_1_wrt_0_1_spec_bb4_1_2_bb3_1_2_bb2_1_2) -> (Float, Float) // user: %54
  // CHECK14:         %54 = partial_apply [callee_guaranteed] %53(%52) : $@convention(thin) (Float, Float, @owned _AD__$s3outyycfU11_7myfoo14L_ySf_SftSf_SftF_bb5__Pred__src_0_1_wrt_0_1_spec_bb4_1_2_bb3_1_2_bb2_1_2) -> (Float, Float) // user: %55
  // CHECK14:         %55 = tuple (%50, %51, %54)                     // user: %56
  // CHECK14:         return %55                                      // id: %56
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test16") {
  ...
  // CHECK16:         %35 = function_ref @$s3outyycfU12_7myfoo16L_4from2atSdSgSDySSSdG_SStFTJpSUpSr021$_AD__$s3outyycfU12_7B50L_4from2atSdSgSDySSSdG_SStF_bb3__Pred__src_0_wrt_0Tf1bn_n : $@convention(thin) (Optional<Double>.TangentVector, @owned _AD__$s3outyycfU12_7myfoo16L_4from2atSdSgSDySSSdG_SStF_bb3__Pred__src_0_wrt_0_spec_bb1_1) -> @owned Dictionary<String, Double> // user: %36
  // CHECK16:         %36 = partial_apply [callee_guaranteed] %35(%34) : $@convention(thin) (Optional<Double>.TangentVector, @owned _AD__$s3outyycfU12_7myfoo16L_4from2atSdSgSDySSSdG_SStF_bb3__Pred__src_0_wrt_0_spec_bb1_1) -> @owned Dictionary<String, Double> // user: %37
  // CHECK16:         %37 = tuple (%33, %36)                          // user: %38
  // CHECK16:         return %37                                      // id: %38
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test17") {
  // RUN: cat %t/out.sil | %FileCheck --check-prefix=CHECK17 %s

  // TODO: no specialized BTE - is this correct?

  // CHECK17-LABEL: {{^}}// reverse-mode derivative of myfoo17
  // CHECK17-NEXT:  // Isolation: nonisolated
  // CHECK17-NEXT:  sil private @$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlFAgHRzlTJrSUpSr : $@convention(thin) <τ_0_0 where τ_0_0 : Differentiable> (@guaranteed Dictionary<String, τ_0_0>, @guaranteed String) -> (@out Optional<τ_0_0>, @owned @callee_guaranteed @substituted <τ_0_0, τ_0_1> (@in_guaranteed τ_0_0) -> @owned τ_0_1 for <Optional<τ_0_0>.TangentVector, Dictionary<String, τ_0_0.TangentVector>>) {
  // CHECK17:         %36 = function_ref @$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlFAgHRzlTJpSUpSr : $@convention(thin) <τ_0_0 where τ_0_0 : Differentiable> (@in_guaranteed Optional<τ_0_0>.TangentVector, @owned _AD__$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlF_bb3__Pred__src_0_wrt_0_16_Differentiation14DifferentiableRzl<τ_0_0>) -> @owned Dictionary<String, τ_0_0.TangentVector> // user: %37
  // CHECK17:         %37 = partial_apply [callee_guaranteed] %36<τ_0_0>(%35) : $@convention(thin) <τ_0_0 where τ_0_0 : Differentiable> (@in_guaranteed Optional<τ_0_0>.TangentVector, @owned _AD__$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlF_bb3__Pred__src_0_wrt_0_16_Differentiation14DifferentiableRzl<τ_0_0>) -> @owned Dictionary<String, τ_0_0.TangentVector> // user: %38
  // CHECK17:         %38 = convert_function %37 to $@callee_guaranteed @substituted <τ_0_0, τ_0_1> (@in_guaranteed τ_0_0) -> @owned τ_0_1 for <Optional<τ_0_0>.TangentVector, Dictionary<String, τ_0_0.TangentVector>> // user: %39
  // CHECK17:         return %38                                      // id: %39
  // CHECK17:       } // end sil function '$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlFAgHRzlTJrSUpSr'

  // CHECK17-LABEL: {{^}}// specialized pullback of myfoo17
  // CHECK17-NEXT:  // Isolation: nonisolated
  // CHECK17-NEXT:  sil private @$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlFAgHRzlTJpSUpSrSd_Tg5 : $@convention(thin) (Optional<Double>.TangentVector, @owned _AD__$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlF_bb3__Pred__src_0_wrt_0_16_Differentiation14DifferentiableRzl<Double>) -> @owned Dictionary<String, Double> {

  func myfoo17<DataType>(from newValues: [String: DataType], at key: String) -> DataType?
  ...
  @differentiable(reverse)
  func caller_myfoo17(newValues: [String: Double]) -> Double {
    return myfoo17(from: newValues, at: "s1")!
  }

  expectEqual(pullback(at: ["s1": 1.0], of: caller_myfoo17)(2), ["s1" : 2.0])
}
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test19") {
  ...
  // CHECK19-ENUM1-LABEL: {{^}}enum _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb1__Pred__src_0_1_wrt_0_1_spec {
  // CHECK19-ENUM1-NEXT:    case bb0(())
  // CHECK19-ENUM1-NEXT:  }

  // CHECK19-ENUM2-LABEL: {{^}}enum _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb2__Pred__src_0_1_wrt_0_1_spec {
  // CHECK19-ENUM2-NEXT:    case bb1((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb1__Pred__src_0_1_wrt_0_1_spec))
  // CHECK19-ENUM2-NEXT:  }

  // CHECK19-ENUM3-LABEL: {{^}}enum _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb3__Pred__src_0_1_wrt_0_1_spec {
  // CHECK19-ENUM3-NEXT:    case bb1((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb1__Pred__src_0_1_wrt_0_1_spec))
  // CHECK19-ENUM3-NEXT:  }

  // CHECK19-ENUM4-LABEL: {{^}}enum _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb4__Pred__src_0_1_wrt_0_1_spec_bb2_1 {
  // CHECK19-ENUM4-NEXT:    case bb3((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb3__Pred__src_0_1_wrt_0_1_spec))
  // CHECK19-ENUM4-NEXT:    case bb2((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb2__Pred__src_0_1_wrt_0_1_spec, (Float, Float, Float)))
  // CHECK19-ENUM4-NEXT:  }

  // CHECK19-ENUM5-LABEL: {{^}}enum _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb5__Pred__src_0_1_wrt_0_1_spec {
  // CHECK19-ENUM5-NEXT:    case bb0(())
  // CHECK19-ENUM5-NEXT:  }

  // CHECK19-ENUM6-LABEL: {{^}}enum _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb6__Pred__src_0_1_wrt_0_1_spec {
  // CHECK19-ENUM6-NEXT:    case bb5((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb5__Pred__src_0_1_wrt_0_1_spec))
  // CHECK19-ENUM6-NEXT:  }

  // CHECK19-ENUM7-LABEL: {{^}}enum _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb7__Pred__src_0_1_wrt_0_1_spec {
  // CHECK19-ENUM7-NEXT:    case bb5((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb5__Pred__src_0_1_wrt_0_1_spec))
  // CHECK19-ENUM7-NEXT:  }

  // CHECK19-ENUM8-LABEL: {{^}}enum _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb8__Pred__src_0_1_wrt_0_1_spec_bb6_1 {
  // CHECK19-ENUM8-NEXT:    case bb7((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb7__Pred__src_0_1_wrt_0_1_spec))
  // CHECK19-ENUM8-NEXT:    case bb6((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb6__Pred__src_0_1_wrt_0_1_spec, (Float, Float, Float)))
  // CHECK19-ENUM8-NEXT:  }

  // CHECK19-ENUM9-LABEL: {{^}}enum _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb9__Pred__src_0_1_wrt_0_1_spec_bb8_1_bb4_1 {
  // CHECK19-ENUM9-NEXT:    case bb8((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb8__Pred__src_0_1_wrt_0_1_spec_bb6_1, (Float, Float)))
  // CHECK19-ENUM9-NEXT:    case bb4((predecessor: _AD__$s3outyycfU14_7myfoo19L_ySf_SftSf_SftF_bb4__Pred__src_0_1_wrt_0_1_spec_bb2_1, (Float, Float)))
  // CHECK19-ENUM9-NEXT:  }

  // CHECK19-LABEL: {{^}}// reverse-mode derivative of myfoo19
  // CHECK19-NEXT:  // Isolation: nonisolated
  // CHECK19-NEXT:  sil private @$s3outyycfU14_7myfoo19L_ySf_SftSf_SftFTJrSSpSSr : $@convention(thin) (Float, Float) -> (Float, Float, @owned @callee_guaranteed (Float, Float) -> (Float, Float)) {
  // CHECK19:         // function_ref specialized pullback of myfoo19
  // CHECK19:         %41 = function_ref @$s3outyycfU14_7myfoo19L_ySf_SftSf_SftFTJpSSpSSr021$_AD__$s3outyycfU14_7b9L_ySf_Sftf1_G28F_bb9__Pred__src_0_1_wrt_0_1Tf1bnn_nTf4nnd_n : $@convention(thin) (Float, Float) -> (Float, Float) // user: %42
  // CHECK19:         %42 = thin_to_thick_function %41 to $@callee_guaranteed (Float, Float) -> (Float, Float) // user: %43
  // CHECK19:         %43 = tuple (%39, %40, %42)                     // user: %44
  // CHECK19:         return %43                                      // id: %44
  // CHECK19:       } // end sil function '$s3outyycfU14_7myfoo19L_ySf_SftSf_SftFTJrSSpSSr'

  // TODO: this is just 'return (0, 0)' - do we want to check this?
  // CHECK19-LABEL: {{^}}// specialized pullback of myfoo19
  // CHECK19-NEXT:  // Isolation: nonisolated
  // CHECK19-NEXT:  sil private [signature_optimized_thunk] [heuristic_always_inline] @$s3outyycfU14_7myfoo19L_ySf_SftSf_SftFTJpSSpSSr021$_AD__$s3outyycfU14_7b9L_ySf_Sftf1_G28F_bb9__Pred__src_0_1_wrt_0_1Tf1bnn_nTf4nnd_n : $@convention(thin) (Float, Float) -> (Float, Float) {
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test20") {
  ...
  // CHECK20-ENUM1-LABEL: {{^}}enum _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb1__Pred__src_0_wrt_0_l_spec<τ_0_0> {
  // CHECK20-ENUM1-NEXT:    case bb0(())
  // CHECK20-ENUM1-NEXT:  }

  // CHECK20-ENUM2-LABEL: {{^}}enum _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb2__Pred__src_0_wrt_0_l_spec<τ_0_0> {
  // CHECK20-ENUM2-NEXT:    case bb0(())
  // CHECK20-ENUM2-NEXT:  }

  // CHECK20-ENUM3-LABEL: {{^}}enum _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb3__Pred__src_0_wrt_0_l_spec<τ_0_0> {
  // CHECK20-ENUM3-NEXT:    case bb2((predecessor: _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb2__Pred__src_0_wrt_0_l_spec<τ_0_0>))
  // CHECK20-ENUM3-NEXT:    case bb1((predecessor: _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb1__Pred__src_0_wrt_0_l_spec<τ_0_0>))
  // CHECK20-ENUM3-NEXT:  }

  // CHECK20-ENUM4-LABEL: {{^}}enum _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb4__Pred__src_0_wrt_0_l_spec<τ_0_0> {
  // CHECK20-ENUM4-NEXT:    case bb3((predecessor: _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb3__Pred__src_0_wrt_0_l_spec<τ_0_0>))
  // CHECK20-ENUM4-NEXT:  }

  // CHECK20-ENUM5-LABEL: {{^}}enum _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb5__Pred__src_0_wrt_0_l_spec<τ_0_0> {
  // CHECK20-ENUM5-NEXT:    case bb3((predecessor: _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb3__Pred__src_0_wrt_0_l_spec<τ_0_0>))
  // CHECK20-ENUM5-NEXT:  }

  // CHECK20-ENUM6-LABEL: {{^}}enum _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb6__Pred__src_0_wrt_0_l_spec_bb5_1_bb4_1<τ_0_0> {
  // CHECK20-ENUM6-NEXT:    case bb5((predecessor: _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb5__Pred__src_0_wrt_0_l_spec<τ_0_0>, (Float, Float)))
  // CHECK20-ENUM6-NEXT:    case bb4((predecessor: _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb4__Pred__src_0_wrt_0_l_spec<τ_0_0>, ()))
  // CHECK20-ENUM6-NEXT:  }

  // CHECK20-LABEL: {{^}}// reverse-mode derivative of myfoo20
  // CHECK20-NEXT:  // Isolation: nonisolated
  // CHECK20-NEXT:  sil private @$s3outyycfU15_7myfoo20L_yS2f_xmtlFlTJrSUpSr : $@convention(thin) <τ_0_0> (Float, @thick τ_0_0.Type) -> (Float, @owned @callee_guaranteed (Float) -> Float) {
  // CHECK20:         // function_ref specialized pullback of myfoo20
  // CHECK20:         %32 = function_ref @$s3outyycfU15_7myfoo20L_yS2f_xmtlFlTJpSUpSr0083$_AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb6__Pred__src_0_wrt_0_l_0_0_ECBcpDCACnjeaTf1bn_n : $@convention(thin) <τ_0_0> (Float, @owned _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb6__Pred__src_0_wrt_0_l_spec_bb5_1_bb4_1<τ_0_0>) -> Float // user: %33
  // CHECK20:         %33 = partial_apply [callee_guaranteed] %32<τ_0_0>(%31) : $@convention(thin) <τ_0_0> (Float, @owned _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb6__Pred__src_0_wrt_0_l_spec_bb5_1_bb4_1<τ_0_0>) -> Float // user: %34
  // CHECK20:         %34 = tuple (%30, %33)                          // user: %35
  // CHECK20:         return %34                                      // id: %35
  // CHECK20:       } // end sil function '$s3outyycfU15_7myfoo20L_yS2f_xmtlFlTJrSUpSr'

  // CHECK20-LABEL: {{^}}// specialized pullback of myfoo20
  // CHECK20-NEXT:  // Isolation: nonisolated
  // CHECK20-NEXT:  sil private @$s3outyycfU15_7myfoo20L_yS2f_xmtlFlTJpSUpSr0083$_AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb6__Pred__src_0_wrt_0_l_0_0_ECBcpDCACnjeaTf1bn_n : $@convention(thin) <τ_0_0> (Float, @owned _AD__$s3outyycfU15_7myfoo20L_yS2f_xmtlF_bb6__Pred__src_0_wrt_0_l_spec_bb5_1_bb4_1<τ_0_0>) -> Float {
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test21") {
  // TODO: only non-specialized pullback present, is this OK?
  // TODO: RUN cat %t/out.sil | %FileCheck --check-prefix=CHECK21 %s

  // CHECK21-LABEL: {{^}}// specialized pullback of myfoo21
