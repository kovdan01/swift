...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test17") {
  ...
  // CHECK17:         %[[#T34:]] = function_ref @$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlFAgHRzlTJpSUpSr : $@convention(thin) <τ_0_0 where τ_0_0 : Differentiable> (@in_guaranteed Optional<τ_0_0>.TangentVector, @owned _AD__$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlF_bb3__Pred__src_0_wrt_0_16_Differentiation14DifferentiableRzl<τ_0_0>) -> @owned Dictionary<String, τ_0_0.TangentVector> // user: %[[#T35:]]
  // CHECK17:         %[[#T35]] = partial_apply [callee_guaranteed] %[[#T34]]<τ_0_0>(%[[#]]) : $@convention(thin) <τ_0_0 where τ_0_0 : Differentiable> (@in_guaranteed Optional<τ_0_0>.TangentVector, @owned _AD__$s3outyycfU13_7myfoo17L_4from2atxSgSDySSxG_SSt16_Differentiation14DifferentiableRzlF_bb3__Pred__src_0_wrt_0_16_Differentiation14DifferentiableRzl<τ_0_0>) -> @owned Dictionary<String, τ_0_0.TangentVector> // user: %[[#T36:]]
  // CHECK17:         %[[#T36]] = convert_function %[[#T35]] to $@callee_guaranteed @substituted <τ_0_0, τ_0_1> (@in_guaranteed τ_0_0) -> @owned τ_0_1 for <Optional<τ_0_0>.TangentVector, Dictionary<String, τ_0_0.TangentVector>>
  // CHECK17:         return %[[#T36]]
...
AutoDiffClosureSpecializationTests.testWithLeakChecking("Test19") {
  ...
  // CHECK19:         %[[#T45:]] = function_ref @$s3outyycfU14_7myfoo19L_ySf_SftSf_SftFTJpSSpSSr021$_AD__$s3outyycfU14_7b9L_ySf_Sftf1_G28F_bb9__Pred__src_0_1_wrt_0_1Tf1bnn_nTf4nnd_n : $@convention(thin) (Float, Float) -> (Float, Float) // user: %[[#T46:]]
